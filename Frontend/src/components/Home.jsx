...
function SlotBooking() {
    return (
            ...
            <div className="slottime">
                <div className="slottime-content">
                    ...
                    <Row>
                        ...
                        <Col><Link to="/SlotDetails"><Button className="Slot-Button"  type="button">View</Button></Link></Col>
                    </Row>
                </div>
            </div>
            <div className="slottime">
        ...
        <div className="plus-btn">
           <Link to="/book"> <Button  variant="light" type="button" className="btn btn-default btn-circle">+</Button></Link>
            </div>
            </div>
